...
public class DriverManager {
    ...
    public void setUpWithClearCache() throws MalformedURLException {
    ...
    public void setUpWithoutClearCache() throws MalformedURLException {
        DesiredCapabilities desiredCapabilities = new DesiredCapabilities();
        desiredCapabilities.setCapability(MobileCapabilityType.PLATFORM_NAME, MobilePlatform.ANDROID);
        desiredCapabilities.setCapability(MobileCapabilityType.DEVICE_NAME, "Test");
        desiredCapabilities.setCapability(MobileCapabilityType.UDID, "emulator-5554");
    ...
    public void clearAppCache() {
        driver.executeScript("mobile:shell", ImmutableMap.of("command", "pm", "args", "clear com.hmh.api"));
    }
